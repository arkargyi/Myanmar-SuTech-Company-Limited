...
export default function VirtualTour() {
  ...
  return (
    <div className="w-full bg-slate-900 rounded-2xl overflow-hidden relative shadow-2xl border border-slate-800">
      {/* Tour Header */}
      ...
      >
        <motion.div
          ...
          dragElastic={0.1}
          className="absolute top-0 left-0 h-full min-w-max"
        >
          {/* Main Panorama Image */}
          <img 
            ref={imageRef}
